<template>
    <b-modal id="modalEditarEntradaEmble" v-model="isShow" @ok="submit" @cancel="close" @hidden="close" size="xl"
        ok-title="Guardar" cancel-title="Cancelar" title="Editar Jurisprudencia Emblemático" bodyScrolling no-close-on-backdrop
        ...
        <form id="formEditarEmtradaEmble" @submit.prevent="submit">
            <div class="row">
                ...
                <div class="col-12 mb-3" :class="{ error: validation.hasError('modelo.KEYWORDS') }">
