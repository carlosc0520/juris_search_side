<template>
    <b-modal id="modalEditarEntradaEmble" v-model="isShow" @ok="submit" @cancel="close" @hidden="close" size="xl"
        ok-title="Guardar" cancel-title="Cancelar" title="Editar Jurisprudencia Emblemático" bodyScrolling
        no-close-on-backdrop no-close-on-esc :hide-footer="loadingSubmit">

        <form id="formEditarEmtradaEmble" @submit.prevent="submit">
            <div class="row">
                ...
                <div class="col-md-8 col-12 mb-3">
                    ...
                    <input type="text" :class="{ error: validation.hasError('modelo.CASO') }" v-model="modelo.CASO"
                ...
                <div class="col-12 mb-3">
                    ...
                    <b-form-tags :class="{ error: validation.hasError('modelo.KEYWORDS') }" separator=","
...
export default {
    ...
    methods: {
        ...
        UpdateLocaleStorage() {
            let data = JSON.parse(localStorage.getItem("emblematiceEntriesEdit"));
            this.modelo = data;
        },
        async submit(e) {
            e.preventDefault();
